...
import com.mozared.batterystatus.BatteryReceiver;
...
public class NotificationHelper {
    public static int ALARM_TYPE_RTC = 1;
    ...
    public static void scheduleRepeatingRTCNotification(Context context) {
       ...
       // Intent intent = new Intent(context, AlarmReceiver.class);
        Intent intent2 = new Intent(context, BatteryReceiver.class);

        //Setting alarm pending intent
    //    alarmIntentRTC = PendingIntent.getBroadcast(context, ALARM_TYPE_RTC, intent, PendingIntent.FLAG_UPDATE_CURRENT);
        alarmIntentRTC = PendingIntent.getBroadcast(context, ALARM_TYPE_RTC, intent2, PendingIntent.FLAG_UPDATE_CURRENT);
